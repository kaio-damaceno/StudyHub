...
const CurrentBookmarkPopup = ({ 
    ...
    // Lista única de pastas existentes
...
const AddressBar = forwardRef<AddressBarRef, AddressBarProps>(({ 
  ...
  // POPUP STATE
  const [activePopup, setActivePopup] = useState<'none' | 'extensions' | 'bookmarks' | 'downloads' | 'menu'>('none');
  ...
  const controlsRef = useRef<HTMLDivElement>(null); // Ref para área de botões desktop
